...
urlpatterns = [
    ...
    path('adicionar_obrigacao/<int:empresa_id>/', views.adicionarObrigacao, name='adicionar_obrigacao'),
    path('editar_obrigacao/<int:empresa_id>/<int:obrigacao_id>', views.editarObrigacao, name='editarObrigacao'),
    path('deletar_obrigacao/<int:empresa_id>/<int:obrigacao_id>', views.deletarObrigacao, name='deletar_obrigacao'),
